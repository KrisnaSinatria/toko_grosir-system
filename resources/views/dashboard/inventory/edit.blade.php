...
<body class="font-inter">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-100 min-h-screen transition-all main">
        ...
        <div class="p-6">
            <form action="/dashboard/inventory/{{ $inventory->id }}" method="post" class="max-w-2xl p-6 bg-white rounded-lg">
                <h1 class="text-xl font-semibold mb-8">Buat Inventaris :</h1>
                @method('put')
                @csrf
                  <div class="">
                    <div class="">
                      <div class="mb-5">
                        <label for="id_product" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nama Produk</label>
                         <select name="id_product" id="" value="{{ old('id_product', $inventory->product->name_product ) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-secondary dark:border-secondary dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
                            <option value="{{ $inventory->id }}">{{ $inventory->product->name_product }}</option>
                      ...
                      <div class="mb-5">
                        <label for="id_supplier" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nama Supplier</label>
                         <select name="id_supplier" id="" value="{{ old('id_supplier',  ) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-secondary dark:border-secondary dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
                      ...
                      <div class="mb-5">
                        <label for="stock" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Stock Awal</label>
                        <input type="integer" name="stock" id="stock"  value="{{ old('stock', $inventory->stock) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" min="1" readonly/>
                        @error('stock')
                            <div class="text-red-500 text-sm">
                              {{ $message }}
                            </div>
                      ...
                      <div class="mb-5">
                        <label for="operation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">stock keluar/masuk</label>
                         <select name="operation" id="" value="{{ old('operation',) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-secondary dark:border-secondary dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
                      ...
                      <div class="mb-5">
                        <label for="finalstock" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">stock</label>
                        <input type="number" name="finalstock" id="finalstock"  value="{{ old('finalstock') }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" min="1"/>
                        @error('finalstock')
                            <div class="text-red-500 text-sm">
                              {{ $message }}
                            </div>
                      ...
                      <div class="mb-5">
                        <label for="order_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Tanggal Order</label>
                        <input type="date" name="order_date" id="order_date"  value="{{ old('order_date', $inventory->order_date) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required/>
                        @error('order_date')
                            <div class="text-red-500 text-sm">
                              {{ $message }}
                            </div>
                      ...
                      <button type="submit" name="create" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah Fasilitas</button>
