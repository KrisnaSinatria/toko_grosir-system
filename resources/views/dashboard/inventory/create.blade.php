...
<body class="font-inter">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-100 min-h-screen transition-all main">
        ...
        <div class="p-6">
            <form action="/dashboard/inventory" method="post" class="max-w-2xl p-6 bg-white rounded-lg">
                  ...
                  <div class="">
                    <div class="">
                      ...
                      <div class="mb-5">
                        ...
                        <input type="number" name="stock" id="stock"  value="{{ old('stock') }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" min="1"/>
                        @error('stock')
                            <div class="text-red-500 text-sm">
                              {{ $message }}
                            </div>
                      ...
                      <div class="mb-5">
                        ...
                        <input type="date" name="order_date" id="order_date"  value="{{ old('order_date') }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required/>
                        @error('order_date')
                            <div class="text-red-500 text-sm">
                              {{ $message }}
                            </div>
