            ...
            <div class="">
                <div class="bg-primary p-6 xl:px-8 border-2 border-gray-300 rounded-lg">
                    <div class="flex justify-between items-center mb-4 xl:mb-8">
                        <h1 class="font-semibold text-lg">Ubah Staff</h1>
                    </div>
                    <div class="jantuk">
                        <form action="/dashboard/staff/{{ $staff->id }}" method="post" class="">
                            @method('put')
                            @csrf
                            <div class="w-full flex flex-wrap justify-between">
                                <div class="w-[48.5%] mb-5">
                                    <label for="username" class="font-semibold text-base mb-4 block">Nama Staff</label>
                                    <input type="text" name="username" id="username"  value="{{ old('username', $staff->username) }}" class="text-sm p-3 rounded-md w-full border-[1.5px] font-medium border-black border-opacity-[16%]" placeholder="" required />
                                    @error('username')
                                  ...
                                  <div class="w-[48.5%] mb-5">
                                      ...
                                      <input type="password" name="password" id="password"  value="{{ old('password') }}" class="text-sm p-3 rounded-md w-full border-[1.5px] font-medium border-black border-opacity-[16%]" placeholder="password lama sudah tersimpan"/>
                                      @error('password')
                                          <div class="text-red-500 text-sm">
                                            {{ $message }}
                                          </div>
                                  ...
                                  <div class="w-[48.5%] mb-5">
                                    ...
                                    <input type="text" name="address" id="address"  value="{{ old('address', $staff->address) }}" class="text-sm p-3 rounded-md w-full border-[1.5px] font-medium border-black border-opacity-[16%]" required/>
                                    @error('address')
                                        <div class="text-red-500 text-sm">
                                          {{ $message }}
                                        </div>
                                  ...
                                  <div class="w-[48.5%] mb-5">
                                    ...
                                    <input type="number" name="phone" id="phone"  value="{{ old('phone', $staff->phone) }}" class="text-sm p-3 rounded-md w-full border-[1.5px] font-medium border-black border-opacity-[16%]" required/>
                                    @error('phone')
                                        <div class="text-red-500 text-sm">
                                          {{ $message }}
                                        </div>
