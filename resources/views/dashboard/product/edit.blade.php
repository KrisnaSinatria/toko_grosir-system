            ...
            <div class="">
                <div class="bg-primary p-6 xl:px-8 border-2 border-gray-300 rounded-lg">
                    <div class="flex justify-between items-center mb-4 xl:mb-8">
                        <h1 class="font-semibold text-lg">Ubah Produk</h1>
                    </div>
                    <div class="jantuk">
                        <form action="/dashboard/product/{{ $product->slug_product }}" method="post" class="">
                            @method('put')
                            @csrf
                            <div class="w-full flex flex-wrap justify-between">
                                <div class="w-[48.5%] mb-5">
                                    <label for="id_category" class="font-semibold text-base mb-4 block">Nama Kategori</label>
                                    <select name="id_category" id="" value="{{ old('id_category',  $product->category->name_category ) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3">
                                ...
                                <div class="w-[48.5%] mb-5">
                                    ...
                                    <input type="text" name="name_product" id="name_product"  value="{{ old('name_product', $product->name_product) }}" class="text-sm p-3 rounded-md w-full border-[1.5px] font-medium border-black border-opacity-[16%]" placeholder="" required />
                                    @error('name_product')
                                        <div class="text-red-500 text-sm">
                                        {{ $message }}
                                        </div>
                                ...
                                <div class="w-[48.5%] mb-5">
                                    ...
                                    <input type="text" name="slug_product" id="slug_product"   value="{{ old('slug_product', $product->slug_product) }}" class="text-sm p-3 rounded-md w-full border-[1.5px] font-medium border-black border-opacity-[16%]" required readonly/>
                                    @error('slug_product')
                                        <div class="text-red-500 text-sm">
                                        {{ $message }}
                                        </div>
                                ...
                                <div class="w-[48.5%] mb-5">
                                    ...
                                    <div class="flex items-center gap-1 text-sm p-3 rounded-md w-full border-[1.5px] font-medium border-black border-opacity-[16%]">
                                        <span>Rp.</span>
                                        <input type="integer" name="price" id="price"  value="{{ old('price', $product->price) }}" class="w-full outline-none" required/>
                                        @error('price')
                                            <div class="text-red-500 text-sm">
                                            {{ $message }}
                                            </div>
                                ...
                                <div class="w-[48.5%] mb-5">
                                    ...
                                    <input type="number" name="stock" id="stock" value="{{ old('stock', $product->stock) }}" class="text-sm p-3 rounded-md w-full border-[1.5px] font-medium border-black border-opacity-[16%]" readonly/>
                                    @error('stock')
                                        <div class="text-red-500 text-sm">
                                        {{ $message }}
                                        </div>
