    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-100 min-h-screen transition-all main">
        <div class="py-2 px-6 bg-white flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
            ...
            <ul class="flex items-center text-sm ml-4">
                <li class="text-gray-600 mr-2 font-medium">Kategori</li>
            </ul>
        ...
        <div class="p-6">
            <a href="/dashboard/product/category/create" class="p-3 bg-sky-500 text-white rounded-md text-sm">Buat kategori Baru</a>
            <div class="container-box mt-8">
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            <th class="px-4 py-2 bg-gray-200">Id</th>
                            <th class="px-4 py-2 bg-gray-200">Nama Kategori</th>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-gray-100 hover:bg-gray-200">
                            ...
                            <td class="border px-4 py-2">{{ $category->name_category }}</td>
                           
                            <td class="border px-4 py-2">
                                <a href="/dashboard/product/category/{{ $category->slug_category }}/edit" class="text-blue-500">Ubah</a>
                            </td>
                            <td class="border px-4 py-2">
                                <form action="/dashboard/product/category/{{ $category->slug_category }}" method="post">
                                    @method('delete')
                                    @csrf
