...
<body class="font-inter">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-100 min-h-screen transition-all main">
        ...
        <div class="p-6">
        <form action="/dashboard/product/category/{{ $category->slug_category }}" method="post" class="max-w-2xl p-6 bg-white rounded-lg">
            <h1 class="text-xl font-semibold mb-8">Ubah Kategori :</h1>
            @method('put')
            @csrf
              <div class="">
                <div class="">
                  <div class="mb-5">
                    <label for="name_category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nama Kategori</label>
                    <input type="text" name="name_category" id="name_category"  value="{{ old('name_category', $category->name_category ) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="" required />
                    @error('name_category')
                  ...
                  <div class="mb-5">
                    <label for="slug_category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Slug Kategori</label>
                    <input type="text" name="slug_category" id="slug_category"  value="{{ old('slug_category', $category->slug_category) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required readonly/>
                    @error('slug_category')
                        <div class="text-red-500 text-sm">
                          {{ $message }}
                        </div>
