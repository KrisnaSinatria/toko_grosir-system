              ...
              <div class="">
                <div class="">
                  ...
                  <div class="mb-5">
                    ...
                    <input type="text" name="slug_category" id="slug_category"  value="{{ old('slug_category') }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required readonly/>
                    @error('harga')
                        <div class="text-red-500 text-sm">
                          {{ $message }}
                        </div>
