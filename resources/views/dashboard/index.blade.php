                ...
                <div class="bg-primary rounded-lg border-2 border-gray-300 px-4 py-5 xl:px-6 xl:py-6">
                    <div class="flex gap-4">
                        ...
                        <div class="flex flex-col justify-between w-full">
                            <p class="font-medium mb-2 xl:mb-1 text-xs text-gray-400">Jumlah Pemesanan</p>
                            <div class="">
                ...
                <div class="w-full flex flex-col gap-4">
                    <div class="flex flex-col bg-primary p-4 xl:p-6 rounded-lg border-2 border-gray-300">
                        <div class="flex justify-between items-center">
                            <h1 class="pl-3 text-xl font-semibold">Produk Terjual</h1>
                            <div class="pr-3">
                                <form class="">
                                    <select id="countries" class="bg-body border border-gray-300 text-sm rounded-sm w-full p-1.5 px-2">
                                    <option selected>Bulanan</option>
                                    <option value="US">Tahunan</option>
                                    <option value="US">Harian</option>
                                    </select>
                                </form>
                            </div>
                        </div>
                        <div class="">
                            <div class="sm:mt-2 min-w-full xl:mx-auto xl:justify-center h-72 xl:h-80">
                                <div id="withdrawn" class="max-w-full  xl:mx-auto xl:justify-center">
                                </div>
                            </div>
                        </div>
                    </div>
