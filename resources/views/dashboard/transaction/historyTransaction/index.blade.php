                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 bg-gray-200">Total Belanjaan</th>
                            <th class="px-4 py-2 bg-gray-200">Harga dibayar</th>
                            <th class="px-4 py-2 bg-gray-200">Kembalian</th>
                            <th class="px-4 py-2 bg-gray-200">Barang</th>
                            {{-- <th class="px-4 py-2 bg-gray-200">Staff</th> --}}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-2">{{ $transaction->total_amount }}</td>
                            <td class="py-2">{{ $transaction->paid_amount }}</td>
                            <td class="py-2">{{ $transaction->change_amount }}</td>
                            <td class="py-2">
                                <ul class="list-disc pl-5">
                                    @foreach($transaction->items as $item)
                                        <li>{{ $item->product->name_product }} - Jumlah: {{ $item->quantity }} - Total Price: {{ $item->price * $item->quantity}}</li>
                                    @endforeach
                                </ul>
                            </td>
                            {{-- <td class="py-2">{{ Auth::user()->admin->username || Auth::user()->staff->username }}</td> --}}
                            <td class="border px-4 py-2">
                                <a href="/dashboard/transaction/history/{{ $transaction->id }}/edit" class="text-blue-500">Ubah</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
