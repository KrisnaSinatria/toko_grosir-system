<x-main>
                                    ...
                                    <div class="flex items-center justify-between space-x-4 mb-4 product-entry">
                                        ...
                                        <div class="max-w-sm mx-auto">
                                            <div class="relative flex items-center w-36">
                                                ...
                                                <input type="number" name="products[0][quantity]" id="" data-input-counter aria-describedby="helper-text-explanation" class="form-control product-quantity bg-body border-2 border-x-0 border-gray-300 h-11 text-center placeholder:text-gray-900 placeholder:font-medium text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2 pl-3" placeholder="1" required />
    ...
    <x-slot:script>
        ...
        if (event.target.closest('#decrement-button')) {
            ...
            if (inputField && inputField.type === 'number') {
                let currentValue = parseInt(inputField.value, 10) || 1;
                inputField.value = currentValue > 1 ? currentValue - 1 : 1;
                calculateTotal();
            }
        }
    });
