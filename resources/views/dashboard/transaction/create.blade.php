...
<body class="font-inter">
  ...
  <script>
     alert("{{ session('errorAmount') }}");
  </script>
  @elseif(session()->has('Transactionsuccess'))
  <script>
     alert("{{ session('Transactionsuccess') }}");
  </script>
  @elseif(session()->has('errorTransaction'))
  <script>
     alert("{{ session('errorTransaction') }}");
  </script>
  @endif
    <!-- start: Sidebar -->
    <div class="fixed left-0 top-0 w-64 h-full bg-white p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            ...
            @endcan
            <li class="mb-1 group">
                <a href="/logout" class="flex items-center py-2 px-4 text-gray-600 hover:bg-slate-100 hover:text-sky-500 rounded-2xl hover:font-semibold group-[.active]:text-gray-900 group-[.selected]:bg-slate-100 group-[.selected]:text-sky-500">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-100 min-h-screen transition-all main">
        ...
        <div class="p-6">
            <h1 class="text-xl font-semibold mb-8">Buat Transaksi :</h1>
            <form action="/dashboard/transaction" method="post" class="max-w-2xl p-6 bg-white rounded-lg">
                @csrf
                <div class="">
                    <div id="product-list">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="total_amount" id="total_amount" value="0" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" readonly>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="change_amount" id="change_amount" value="{{ $changeAmount }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required readonly />
                        @error('change_amount')
                            <div class="text-red-500 text-sm">
                            {{ $message }}
                            </div>
                ...
                <a href="/logout" class="p-3 text-sm rounded-lg bg-gray-500 text-white font-medium">Kembali</a>
            </form>
        </div>  
    </main>
    ...
    <script>
        ...
        // Initial event listeners for existing products
        ...
        // Calculate initial total amount if editing
        calculateTotal();
    });
    </script>
